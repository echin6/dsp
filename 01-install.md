...
>> I have previously installed both python 2 and 3.  For Anaconda I installed version 2.  I have installed version 3 in the past because certain modules were only compatible with version 3.

###Q2. Which Python Version Installed   

How can you check the version of Python installed if you happen to be on an unfamiliar computer?

>> Type python -V in command prompt
